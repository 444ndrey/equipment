...
Зеленая кнопка **"Скопировать JSON из формы"** формирует его из формы слева и добавляет в буфер обмена, чтобы скопировать JSON из редактора, нажимаем кнопку **"Копировать"** над редактором, JSON скопируется сразу в минифицированном виде.
...
Порядок оборудования имеет значение, на наши сайты, как правило, выводится только первое обордование.
#
